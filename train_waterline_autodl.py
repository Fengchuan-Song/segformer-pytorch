...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_dir", type=str, default='/root/autodl-tmp/SegFromer_waterline')
    parser.add_argument('--wandb_path', type=str, default='/root/autodl-tmp/SegFromer_waterline/wandb', help='path of saving wandb files locally')
    parser.add_argument('--wandb_name', type=str, default='SegFromer_waterline',
    ...
    #------------------------------------------------------------------#
    save_dir            = '/root/autodl-tmp/SegFromer_waterline'
