...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_dir", type=str, default='/data/SegFromer_waterline')
    parser.add_argument('--wandb_path', type=str, default='/data/SegFromer_waterline/wandb', help='path of saving wandb files locally')
    ...
    #------------------------------------------------------------------#
    save_dir            = '/data/SegFromer_waterline'
